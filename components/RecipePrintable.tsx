...
export const RecipePrintable: React.FC<Props> = ({ recipe }) => {
  return (
    <div className="bg-white p-8 sm:p-12 shadow-sm border border-gray-200 mx-auto max-w-[210mm] min-h-[297mm] print-area">
      {/* Header */}
      <div className="flex justify-between items-start border-b-2 border-[#F28C28] pb-4 mb-6">
        <div>
          <h2 className="text-[#F28C28] font-bold text-xl tracking-wider">FORMULAÇÃO TÉCNICA</h2>
      ...
      <div className="text-center mb-10">
        ...
        <div className="h-1 w-24 bg-[#F28C28] mx-auto mt-2"></div>
      </div>

      {/* Ingredients Table */}
      <div className="mb-8">
        <h3 className="text-sm font-bold text-[#F28C28] mb-3 uppercase tracking-widest border-l-4 border-[#F28C28] pl-2">Ingredientes e Composição</h3>
      ...
      {/* Methods */}
      <div className="mb-8">
        <h3 className="text-sm font-bold text-[#F28C28] mb-4 uppercase tracking-widest border-l-4 border-[#F28C28] pl-2">Procedimento Operacional (Modo de Preparo)</h3>
        <div className="space-y-4">
          {recipe.modo_preparo.map((passo, idx) => (
            <div key={idx} className="flex gap-4 items-start">
              ...
              <p className="text-sm text-gray-700 leading-relaxed pt-0.5">{passo}</p>
            </div>
          ))}
        </div>
      </div>
      ...
      {/* Footer */}
      <div className="mt-12 text-center text-[10px] text-gray-300 uppercase tracking-widest border-t pt-4">
